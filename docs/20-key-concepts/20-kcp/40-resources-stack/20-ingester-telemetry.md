...
- [`dashboards/resources-ingester-overview.dashboard.json`](https://github.com/krateoplatformops/resources-ingester/blob/main/telemetry/dashboards/events-ingester-overview.dashboard.json): Grafana dashboard with panels for resource throughput, drop rates, queue depth, and batch flush performance.
