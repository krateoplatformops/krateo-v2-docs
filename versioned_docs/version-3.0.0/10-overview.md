...
If the Kubernetes version is minor than v1.31.x or it the distribution is EKS, Krateo PlatformOps can be deployed via ephemeral clusters like vCluster. You can find more details about this in the [installation guide](./how-to-guides/install-krateo/installing-krateo).
